...
const HeroSection: React.FC = () => {
  ...
  return (
    <MaxWidthWrapper className="relative grid-cols-5 pb-20 sm:pb-32 lg:pb-52 lg:pt-24 lg:grid lg:gap-x-8 lg:pt-32">
      <Image
        src="/right-grid.svg"
        alt="left-grid"
        width={413}
      ...
      <div className="col-span-3 px-6 pt-12 lg:pt-0">
        <div className="mx-auto flex flex-col items-center text-center lg:text-left lg:items-start">
          ...
          <p className="mt-4 text-balance text-center text-xl text-[#F8F8FF] md:text-wrap lg:text-left">
      ...
      <div className="relative col-span-full mt-28 mb-7 flex h-[162px] lg:h-[293px] w-full max-w-[250px] lg:max-w-none justify-center rounded-2xl bg-cyan-300 bg-gradient-to-r from-[#AD99FF] to-[#61FCAE] lg:col-span-2 lg:flex mx-auto">
